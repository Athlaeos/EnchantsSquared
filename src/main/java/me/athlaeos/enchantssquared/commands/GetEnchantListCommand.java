...
public class GetEnchantListCommand implements Command {
	...
	public GetEnchantListCommand(){
		...
		eslist_include_weight = Main.getPlugin().getConfig().getBoolean("eslist_include_weight");
		eslist_include_compatible_items = Main.getPlugin().getConfig().getBoolean("eslist_include_compatible_items");
		eslist_include_max_level = Main.getPlugin().getConfig().getBoolean("eslist_include_max_level");
